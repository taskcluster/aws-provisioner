...
let api = new base.API({
  ...
  description: [
    ...
    '',
    'When a new EC2 instance is instantiated, its user data contains a token',
    'that can be used with the `getSecret` method to retrieve the worker\'s',
    'credentials and any needed passwords or other restricted information.  The',
    'worker is responsible for deleting the secret after retrieving it, to',
    'prevent dissemination of the secret to other proceses which can read the',
    'instance user data.',
    '',
  ].join('\n'),
});
